...
export const ExerciseForm: FC<ExerciseFormProps> = ({ open, exerciseId, onOpenChange }) => {
  const t = useTranslations('Exercises');
  const { form, isUpdate, exerciseName, isLoadingExercise, isLoadError, isPending, handleSubmit } =
    useExerciseFormConfig({ open, exerciseId, onOpenChange });
  const { control } = form;
